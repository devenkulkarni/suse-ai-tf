...
variable "ssh_private_key_path" {
  ...
  default     = null
  validation {
    condition     = var.create_ssh_key_pair || (var.ssh_private_key_path != null && var.ssh_private_key_path != "")
    error_message = "You must provide a non-null ssh_private_key_path when create_ssh_key_pair is false."
  }
}
...
variable "ssh_public_key_path" {
  ...
  default     = null
  validation {
    condition     = var.create_ssh_key_pair || (var.ssh_public_key_path != null && var.ssh_public_key_path != "")
    error_message = "You must provide a non-null ssh_public_key_path when create_ssh_key_pair is false."
  }
}
